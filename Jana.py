...
def cadastrar_venda(numero_cliente, numero_produto):
    ...
    try:
        ...
        nome_element = navegador.find_element(By.XPATH, '//*[@id="autocompletar_pessoa_cliente_fornecedor_id"]')
        ...
        #sleep(10)
        print("Aguarda 240 segundos para liberação")
        for segundo_atual in range(240, 0, -1):
