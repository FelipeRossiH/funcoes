...
# Tarefas do tipo desenvolvimento
...
# Tarefas que contêm "Correção" no título
...
print("Quantidade de tarefas de teste por usuário:")
print(tarefas_por_usuario_teste)
print("Quantidade de tarefas do tipo desenvolvimento:", quantidade_tarefa_desenvolvimento)
print("Quantidade de tarefas de desenvolvimento atribuídas a cada usuário:")
print(tarefas_por_usuario_desenvolvimento)
print("Quantidade de tarefas que contêm 'Correção' no título:", quantidade_tarefa_correcao)
print("Quantidade de tarefas de correção atribuídas a cada usuário:")
print(tarefas_por_usuario_correcao)

# Configurações do email
email_remetente = 'felipe.rossi@sgisistemas.com.br'
email_destinatarios = ['feliperossihav@icloud.com', 'sgi.felipe@gmail.com', 'felipe.rossi@sgisistemas.com.br']  # Lista de destinatários
...
if quantidade_tarefa_teste >0: 
    ...
    Quantidade total de tarefas:", {trf_teste}
